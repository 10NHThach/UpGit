...
namespace WedAPI.Migrations
{
    ...
    [Migration("20240329091134_initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WedAPI.Models.Author", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("WedAPI.Models.Book", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WedAPI.Models.Book", b =>
                {
                    b.HasOne("WedAPI.Models.Author", "Author")
                        .WithMany("Books")
